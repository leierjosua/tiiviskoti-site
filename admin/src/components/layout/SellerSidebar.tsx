...
const navItems = [
  { to: "/myyja", label: "Yhteenveto", icon: Home },
  { to: "/myyja/kalenteri", label: "Kalenteri", icon: CalendarDays },
  { to: "/myyja/inbound", label: "Inbound-liidit", icon: Inbox },
  { to: "/myyja/tarjoukset", label: "Tarjoukset", icon: FileText },
  { to: "/myyja/tarjouspohja", label: "Tarjouspohja", icon: FileText },
  { to: "/myyja/sahkoposti", label: "Sähköposti", icon: Mail },
  { to: "/myyja/kylmasoitot", label: "Kylmäsoitot", icon: PhoneOutgoing },
  { to: "/myyja/alennuskoodit", label: "Alennuskoodit", icon: Ticket },
];

...
<section class="sec" id="tietosuoja" style="padding-top:clamp(40px,5vw,72px)"><div class="wrap">
  <div class="lg">
    ...
    <p><b>Jos teet varauksen, jätät tarjouspyynnön tai varaat kartoituskäynnin mainoslinkistä
      tultuasi</b>, ilmoitamme mainosalustalle että kyseinen mainosklikki johti kauppaan. Ilmoitus
      lähetetään <b>vain toteutuneesta tapahtumasta</b> ja vasta kun se on tapahtunut. Pelkästä
      sivuston selaamisesta ei ilmoiteta mainosalustoille mitään.</p>

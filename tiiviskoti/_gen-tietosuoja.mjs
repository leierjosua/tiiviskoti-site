...
<section class="sec" id="tietosuoja" style="padding-top:clamp(40px,5vw,72px)"><div class="wrap">
  <div class="lg">
    ...
    <span class="upd">Päivitetty 24.8.2026</span>
    ...
    <p>Mittaamme sivuston käyttöä <b>evästeettömästi ja anonyymisti</b> oman järjestelmämme avulla:
      ...
      kehittämiseen ja mainontamme osuvuuden mittaamiseen, ei profilointiin. Mittaustietoja ei
      luovuteta kolmansille; ainoa poikkeus on alla kuvattu ilmoitus toteutuneesta kaupasta
      mainosalustalle. Käsittelyn perusteena on oikeutettu etu.</p>
    ...
    <ul>
      ...
      <li><code>tk_fbc</code> (paikallinen muisti, 7 vrk) — Facebook- tai Instagram-mainoksen klikin
      ...
      <li><code>tk_vid</code> (paikallinen muisti) — satunnaisluku, joka ei ole johdettu mistään
        ...
        Tunniste ei seuraa sinua muille sivustoille. Voit poistaa sen tyhjentämällä selaimen tiedot.</li>
    </ul>
    <p><b>Jos teet varauksen, jätät tarjouspyynnön tai varaat kartoituskäynnin mainoslinkistä
      tultuasi</b>, ilmoitamme mainosalustalle että kyseinen mainosklikki johti kauppaan.</p>
    <p><b>Lisäksi ilmoitamme Metalle, kun siirryt hintalaskurista valitsemaan aikaa</b> — eli kun
      olet valinnut ovet ja ikkunat ja nähnyt hinnan. Ilmoitus sisältää lasketun hinnan, kohteiden
      määrän ja postinumeron. Se ei sisällä nimeäsi eikä yhteystietojasi, koska et ole siinä
      vaiheessa vielä antanut niitä. Tarkoitus on kohdentaa mainoksia paremmin, jotta niitä
      näytetään vähemmän niille joita palvelu ei kiinnosta. <b>Pelkästä sivujen selaamisesta tai
      hintalaskurin avaamisesta ei ilmoiteta mainosalustoille mitään</b> — ilmoitus lähtee vasta kun
      olet itse edennyt ajanvaraukseen asti.</p>
    <p><b>Google Ads.</b> Ilmoitus sisältää mainosklikin tunnisteen, ajankohdan, kaupan arvon sekä
      sisäisen työnumeromme — <b>ei nimeäsi, yhteystietojasi eikä osoitettasi</b>.</p>
    <p><b>Meta (Facebook ja Instagram).</b> Käytämme Metan Conversions API -rajapintaa, joka toimii
      palvelimeltamme — selaimeesi ei ladata Metan seurantaskriptiä eikä aseteta Metan evästeitä.
      Ilmoitus on tässä laajempi kuin Googlelle, ja siksi se kuvataan tarkasti: se sisältää
      <b>nimesi, sähköpostiosoitteesi, puhelinnumerosi sekä postinumerosi ja -toimipaikkasi
      tiivisteinä</b> (SHA-256-yksisuuntainen muunnos, jota Meta käyttää tunnistaakseen onko
      kyseessä sen oma käyttäjä), Metan oman mainosklikin tunnisteen, tapahtuman arvon ja
      sisäisen tunnisteemme sekä <b>IP-osoitteesi ja selaintyyppisi</b>. Tiiviste ei ole
      luettavaa tekstiä, mutta se ei ole myöskään anonyymi: se on tarkoitettu juuri sinun
      tunnistamiseesi Metan käyttäjien joukosta. Käsittelyn perusteena on oikeutettu etu (oman
      mainontamme tuloksellisuuden mittaaminen).</p>
    <p>Voit estää mainonnan mittaamisen tyhjentämällä selaimesi paikallisen muistin tai käyttämällä
      sivustoa ilman mainoslinkkiä. Jos haluat, ettemme ilmoita tapahtumaasi mainosalustalle,
      kerro siitä yhteydenoton yhteydessä tai ota yhteyttä
      <a href="mailto:info@tiiviskoti.fi">info@tiiviskoti.fi</a> — poistamme tiedon.</p>

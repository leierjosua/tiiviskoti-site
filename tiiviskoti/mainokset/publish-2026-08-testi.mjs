...
const REELS = [
  { file: 'kortti-veto', adName: 'TK27 - Kortti veto', headline: HL,
    ...
    message: 'Vetääkö kotona? Lämpökamera näyttää mistä kohdista lämpö karkaa, ja tiivisteet vaihdetaan samalla käynnillä. Ikkuna 95 €, ulko-ovi 119 €.\n\n👉 tiiviskoti.fi' },
  ...
  { file: 'kortti-lampotila', adName: 'TK27 - Lämpötila', headline: HL,
    ...
    message: 'Pakkasta ulkona, lämmin sisällä — tiiviste on se raja niiden välissä. Kun se on kulunut, lämpö karkaa. Ikkuna 95 €, ulko-ovi 119 €.\n\n👉 tiiviskoti.fi' },
...
const SYOTE = [
  ...
  { file: 'mainos-niukka-veto.png', adName: 'TK27 - Niukka veto', headline: HL,
    description: 'Ulko-ovi 119 €, ikkuna 95 €.',
  ...
  { file: 'mainos-t1-rako.png', adName: 'TK27 - Rako', headline: HL,
    description: 'Ikkuna 95 €, ulko-ovi 119 €.',
